<div id="sidebar">
	...
	<h3 style="text-align:center">Current version ${project.version}</h3>	
	...
	<ul class="sidemenu">				
		...
		<li><a href="http://sourceforge.net/apps/wordpress/dynamicreports/">News </a><a href="http://sourceforge.net/apps/wordpress/dynamicreports/feed/"><img style="vertical-align:middle" class="preview" src="${page.path}images/rss.png" alt="RSS" width="12" height="12"/></a></li>
	...
	<h3>Project info</h3>
	<ul class="sidemenu">
		<li><a href="${page.path}license.html">License</a></li>
	...
	<a href="http://sourceforge.net/projects/dynamicreports"><img class="preview" src="http://sflogo.sourceforge.net/sflogo.php?group_id=313754&amp;type=12" width="120" height="30" alt="Get DynamicReports at SourceForge.net. Fast, secure and Free Open Source software downloads"/></a>
	</p>
