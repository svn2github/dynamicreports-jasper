...
public class GenerateSite2 {
	...
	private static final String templates_path = "src/site2/templates/";
	private static final String pages_path = "src/site2/pages/";
	...
	public GenerateSite2() throws Exception {
		generatePages();
	...
	private void generateExamples() throws Exception {
		...
		generateExampleHtml("dynamicreports-defaults", "", "", GenerateSite2.class.getResourceAsStream("/dynamicreports-defaults.xml"), "xml");
	}
