...
public abstract class AbstractJasperCrosstabStyleTest extends AbstractJasperStyleTest {
	...
	protected void crosstabHeaderElementBorderTest(String name, int index, Color topColor, LineStyleEnum topLineStyle, float top, Color bottomColor, LineStyleEnum bottomLineStyle, float bottom, Color leftColor, LineStyleEnum leftLineStyle, float left, Color rightColor, LineStyleEnum rightLineStyle, float right) {
	...
	protected void crosstabGroupHeaderBorderTest(AbstractCrosstabGroupBuilder<?, ?, ?> group, int index, Color topColor, LineStyleEnum topLineStyle, float top, Color bottomColor, LineStyleEnum bottomLineStyle, float bottom, Color leftColor, LineStyleEnum leftLineStyle, float left, Color rightColor, LineStyleEnum rightLineStyle, float right) {
		borderTest(getPrefix(1) + JasperTestUtils.getCrosstabGroupHeaderName(group), index, topColor, topLineStyle, top, bottomColor, bottomLineStyle, bottom, leftColor, leftLineStyle, left, rightColor, rightLineStyle, right);
	}
	...
	protected void crosstabGroupTotalHeaderBorderTest(AbstractCrosstabGroupBuilder<?, ?, ?> group, int index, Color topColor, LineStyleEnum topLineStyle, float top, Color bottomColor, LineStyleEnum bottomLineStyle, float bottom, Color leftColor, LineStyleEnum leftLineStyle, float left, Color rightColor, LineStyleEnum rightLineStyle, float right) {
		borderTest(getPrefix(1) + JasperTestUtils.getCrosstabGroupTotalHeaderName(group), index, topColor, topLineStyle, top, bottomColor, bottomLineStyle, bottom, leftColor, leftLineStyle, left, rightColor, rightLineStyle, right);
	}
