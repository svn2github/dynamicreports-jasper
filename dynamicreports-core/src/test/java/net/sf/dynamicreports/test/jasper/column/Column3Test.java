	...
	protected void configureReport(JasperReportBuilder rb) {
		rb.setLocale(Locale.ENGLISH)
			...
			.columns(
					...
					column2 = col.column("Column2", "field2", type.dateType()),
					column3 = col.column("Column3", "field3", type.dateYearToMinuteType()), 
					column4 = col.column("Column4", "field4", type.doubleType()), 
					column5 = col.column("Column5", "field5", type.bigDecimalType()),
					column6 = col.column("Column6", "field6", new CustomType()));
	}
