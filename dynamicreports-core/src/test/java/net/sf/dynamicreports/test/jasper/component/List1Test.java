		...
		rb.setWhenNoDataType(WhenNoDataType.ALL_SECTIONS_NO_DETAIL)
			...
			.title(
				cmp.horizontalList()
					...
					.add(cmp.hListCell(
							cmp.verticalList()	
								...
								.add(cmp.text(""),
										cmp.horizontalList()
										 	.setStyle(style)
										 	.add(cmp.text(""), cmp.text(""))
										 	.add(5, cmp.text("").setWidth(50)),
										 	cmp.text(""))
								.add(cmp.vListCell(
										cmp.horizontalList(cmp.text(""), cmp.text(""))
												.setStyle(style)).widthFixedOnCenter().heightFixed())).widthFixed().heightFixedOnMiddle())					
					.add(
							cmp.verticalList()
								.setStyle(style)
								.add(cmp.text(""))
								.add(
								cmp.vListCell(cmp.text("").setHeight(30).setWidth(50)),
								cmp.vListCell(cmp.text("").setWidth(50)).heightFixed(),
								cmp.vListCell(cmp.text("").setWidth(50)).widthFixedOnLeft().heightFixed(),
								cmp.vListCell(cmp.text("").setWidth(50)).widthFixedOnLeft(),
								cmp.vListCell(cmp.text("").setWidth(50)).widthFixedOnCenter().heightFixed(),
								cmp.vListCell(cmp.text("").setWidth(50)).widthFixedOnCenter(),
								cmp.vListCell(cmp.text("").setWidth(50)).widthFixedOnRight().heightFixed(),
								cmp.vListCell(cmp.text("").setWidth(50)).widthFixedOnRight()))
					...
					.add(cmp.hListCell( 
							cmp.verticalList(cmp.text("").setWidth(50), cmp.text("").setWidth(50))
							 	.setStyle(style)).widthFixed().heightFixedOnMiddle())
