...
public class VerticalListTest extends AbstractJasperPositionTest {
	...
	public void test() {
		...
		elementPositionTest("title.list2", 0, 0, 42, 128, 58);
		elementPositionTest("title.list3", 0, 0, 0, 64, 58);
		
		elementPositionTest("title.textField1", 0, 0, 0, 128, 16);
		elementPositionTest("title.textField2", 0, 0, 16, 128, 26);
		...
		elementPositionTest("title.textField7", 0, 0, 100, 128, 16);
	}
}
