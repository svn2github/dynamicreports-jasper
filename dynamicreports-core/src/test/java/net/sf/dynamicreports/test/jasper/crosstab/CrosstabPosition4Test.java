...
public class CrosstabPosition4Test extends AbstractJasperCrosstabPositionTest {
	...
	public void test() {
		...
		for (int i = 0; i < 3; i++) {
			crosstabCellPositionTest(measure1, null, columnGroup, i, 0, 0, 40, 30);
			crosstabCellPositionTest(measure2, null, columnGroup, i, 40, 0, 40, 30);
		}
		for (int i = 0; i < 2; i++) {
			crosstabCellPositionTest(measure1, rowGroup, null, i, 0, 0, 40, 30);
			crosstabCellPositionTest(measure2, rowGroup, null, i, 40, 0, 40, 30);
		}
		crosstabCellPositionTest(measure1, rowGroup, columnGroup, 0, 0, 0, 40, 30);
		crosstabCellPositionTest(measure2, rowGroup, columnGroup, 0, 40, 0, 40, 30);
	}
