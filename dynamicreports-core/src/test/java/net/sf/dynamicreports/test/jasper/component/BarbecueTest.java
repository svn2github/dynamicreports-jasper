...
public class BarbecueTest extends AbstractJasperTest {
	...
	protected void configureReport(JasperReportBuilder rb) {
		rb.setTemplate(template().setBarcodeHeight(20).setBarcodeStyle(stl.style(2)))
			.title(
				bcode.barbecue_2of7(exp.jasper("12345678")),
				bcode.barbecue_3of9(exp.jasper("12345678")),
				bcode.barbecue_bookland(exp.jasper("1234567890")),
				bcode.barbecue_codabar(exp.jasper("12345678")),
				bcode.barbecue_code128(exp.jasper("12345678")),
				bcode.barbecue_code128A(exp.jasper("12345678")),
				bcode.barbecue_code128B(exp.jasper("12345678")),
				bcode.barbecue_code128C(exp.jasper("12345678")),
				bcode.barbecue_code39(exp.jasper("12345678")),
				bcode.barbecue_code39Extended(exp.jasper("12345678")),
				bcode.barbecue_ean128(exp.jasper("12345678")),
				bcode.barbecue_ean13(exp.jasper("123456789012")),
				bcode.barbecue_globalTradeItemNumber(exp.jasper("12345678")),
				bcode.barbecue_int2of5(exp.jasper("12345678")),
				bcode.barbecue_monarch(exp.jasper("12345678")),
				bcode.barbecue_nw7(exp.jasper("12345678")),
				bcode.barbecue_pdf417(exp.jasper("12345678")),
				bcode.barbecue_postnet(exp.jasper("12345678")),
				bcode.barbecue_randomWeightUpca(exp.jasper("12345678901")),
				bcode.barbecue_scc14ShippingCode(exp.jasper("12345678")),
				bcode.barbecue_shipmentIdentificationNumber(exp.jasper("12345678")),
				bcode.barbecue_sscc18(exp.jasper("12345678")),
				bcode.barbecue_std2of5(exp.jasper("12345678")),
				bcode.barbecue_ucc128(exp.jasper("12345678")).setApplicationIdentifierExpression("1"),
				bcode.barbecue_upca(exp.jasper("12345678901")),
				bcode.barbecue_usd3(exp.jasper("12345678")),
				bcode.barbecue_usd4(exp.jasper("12345678")),
				bcode.barbecue_usps(exp.jasper("12345678")),

				bcode.barbecue_ucc128("12345678").setFixedHeight(50)
					.setApplicationIdentifierExpression(exp.jasper("1"))
					.setDrawText(true)
