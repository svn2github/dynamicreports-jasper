...
public class BarbecueTest extends AbstractJasperTest {
	...
	protected void configureReport(JasperReportBuilder rb) {
		rb.setTemplate(template().setBarcodeHeight(20).setBarcodeStyle(stl.style(2)))
			.title(
				bcode.barbecue_2of7(exp.jasperSyntaxEscapedText("12345678")),
				bcode.barbecue_3of9(exp.jasperSyntaxEscapedText("12345678")),
				bcode.barbecue_bookland(exp.jasperSyntaxEscapedText("1234567890")),
				bcode.barbecue_codabar(exp.jasperSyntaxEscapedText("12345678")),
				bcode.barbecue_code128(exp.jasperSyntaxEscapedText("12345678")),
				bcode.barbecue_code128A(exp.jasperSyntaxEscapedText("12345678")),
				bcode.barbecue_code128B(exp.jasperSyntaxEscapedText("12345678")),
				bcode.barbecue_code128C(exp.jasperSyntaxEscapedText("12345678")),
				bcode.barbecue_code39(exp.jasperSyntaxEscapedText("12345678")),
				bcode.barbecue_code39Extended(exp.jasperSyntaxEscapedText("12345678")),
				bcode.barbecue_ean128(exp.jasperSyntaxEscapedText("12345678")),
				bcode.barbecue_ean13(exp.jasperSyntaxEscapedText("123456789012")),
				bcode.barbecue_globalTradeItemNumber(exp.jasperSyntaxEscapedText("12345678")),
				bcode.barbecue_int2of5(exp.jasperSyntaxEscapedText("12345678")),
				bcode.barbecue_monarch(exp.jasperSyntaxEscapedText("12345678")),
				bcode.barbecue_nw7(exp.jasperSyntaxEscapedText("12345678")),
				bcode.barbecue_pdf417(exp.jasperSyntaxEscapedText("12345678")),
				bcode.barbecue_postnet(exp.jasperSyntaxEscapedText("12345678")),
				bcode.barbecue_randomWeightUpca(exp.jasperSyntaxEscapedText("12345678901")),
				bcode.barbecue_scc14ShippingCode(exp.jasperSyntaxEscapedText("12345678")),
				bcode.barbecue_shipmentIdentificationNumber(exp.jasperSyntaxEscapedText("12345678")),
				bcode.barbecue_sscc18(exp.jasperSyntaxEscapedText("12345678")),
				bcode.barbecue_std2of5(exp.jasperSyntaxEscapedText("12345678")),
				bcode.barbecue_ucc128(exp.jasperSyntaxEscapedText("12345678")).setApplicationIdentifierExpression("1"),
				bcode.barbecue_upca(exp.jasperSyntaxEscapedText("12345678901")),
				bcode.barbecue_usd3(exp.jasperSyntaxEscapedText("12345678")),
				bcode.barbecue_usd4(exp.jasperSyntaxEscapedText("12345678")),
				bcode.barbecue_usps(exp.jasperSyntaxEscapedText("12345678")),

				bcode.barbecue_ucc128("12345678").setFixedHeight(50)
					.setApplicationIdentifierExpression(exp.jasperSyntaxEscapedText("1"))
					.setDrawText(true)
