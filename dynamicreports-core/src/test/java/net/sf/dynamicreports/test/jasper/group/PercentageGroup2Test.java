...
public class PercentageGroup2Test extends AbstractJasperValueTest {
	...
	protected void configureReport(JasperReportBuilder rb) {		
		...
		rb.setLocale(Locale.ENGLISH)
			.columns(
					...
					column3,
					column4,
					percentage1 = col.percentageColumn(column4),
					percentage2 = col.percentageColumn(column4).setTotalGroup(group2),
					percentage3 = col.percentageColumn(column4).setTotalGroup(group1),
					percentage4 = col.percentageColumn(column4).setTotalType(PercentageTotalType.REPORT))
			.groupBy(
					group1,
					group2,
					group3)
			.subtotalsOfPercentageAtGroupFooter(group3,
					subtotal1 = sbt.percentage(column4),
					subtotal2 = sbt.percentage(column4).setTotalGroup(group1),
					subtotal3 = sbt.percentage(column4).setTotalType(PercentageTotalType.REPORT))
			.subtotalsOfPercentageAtGroupFooter(group2,
					subtotal4 = sbt.percentage(column4),
					subtotal5 = sbt.percentage(column4).setTotalType(PercentageTotalType.REPORT))
			.subtotalsOfPercentageAtGroupFooter(group1,
					subtotal6 = sbt.percentage(column4));
	}
	...
	public void test() {
		...
		columnDetailValueTest(percentage1, 
				"16.67%", "33.33%", "50.00%", 
				"26.67%", "33.33%", "40.00%", 
				"29.17%", "33.33%", "37.50%", 
				"30.30%", "33.33%", "36.36%", 
		...
		columnDetailValueTest(percentage2, 
				"4.76%", "9.52%", "14.29%", 
				"19.05%", "23.81%", "28.57%", 
				"12.28%", "14.04%", "15.79%", 
				"17.54%", "19.30%", "21.05%", 
		...
		columnDetailValueTest(percentage3, 
				"1.28%", "2.56%", "3.85%", 
				"5.13%", "6.41%", "7.69%", 
				"8.97%", "10.26%", "11.54%", 
				"12.82%", "14.10%", "15.38%", 
		...
		columnDetailValueTest(percentage4, 
				"0.33%", "0.67%", "1.00%", 
				"1.33%", "1.67%", "2.00%", 
				"2.33%", "2.67%", "3.00%", 
				"3.33%", "3.67%", "4.00%", 
